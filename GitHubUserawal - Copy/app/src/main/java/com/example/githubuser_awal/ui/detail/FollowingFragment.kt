...
import com.example.githubuser_awal.ui.detail.FollowingViewModel
...
class FollowingFragment : Fragment(R.layout.fragment_follow) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.setListFollowing(requireContext(), username)
        viewModel.getListFollowing().observe(viewLifecycleOwner) { userList ->
            userList?.let {
                adapter.setList(it)
                showLoading(false)
